...
janitor_note: 'LINK001 — [[process/Alfred BIT]] parent process record does not exist
  in vault; same pattern as other Alfred BIT YYYY-MM-DD run records. DIR001 — record
  has type=run but lives in process/; deterministic flag for autofix. Human action:
  create the parent process/Alfred BIT.md record OR move run records to run/.'
mode: quick
name: Alfred BIT 2026-05-26
overall_status: fail
process: '[[process/Alfred BIT]]'
relationships:
- confidence: 1
  context: Same Alfred BIT run series
  source: process/Alfred BIT 2026-05-26.md
  source_anchor: '[run] Alfred BIT 2026-05-26'
  target: process/Alfred BIT 2026-05-28.md
  target_anchor: '[run] Alfred BIT 2026-05-28'
  type: related-to
- confidence: 1
  context: Same Alfred BIT series
  source: run/Alfred BIT 2026-05-26.md
  source_anchor: Alfred BIT 2026-05-26
  target: run/Alfred BIT 2026-05-28.md
  target_anchor: Alfred BIT 2026-05-28
  type: related-to
started: '2026-05-26T14:07:49.679589-03:00'
status: completed
tags:
- bit
- health
...
# Alfred BIT 2026-05-26

Generated at 1407 ADT.

## Summary

Alfred BIT (quick) — [FAIL]
  started:  2026-05-26T17:07:44.096253+00:00
  finished: 2026-05-26T17:07:49.679500+00:00
  elapsed:  5583 ms
...
[ OK ] curator  (2250 ms)
    ...
    [ OK ] anthropic-auth  (1837 ms) — count_tokens ok
    [ OK ] last-successful-process — inbox empty; last process 0.5h ago

[ OK ] janitor  (1921 ms)
    [ OK ] vault-path — /home/andrew/alfred/vault
    [ OK ] state-file — data/janitor_state.json
    [ OK ] backend — backend=claude
    [ OK ] anthropic-auth  (1728 ms) — count_tokens ok
    [ OK ] last-successful-sweep — last sweep 0.2h ago

[ OK ] distiller  (1874 ms)
    [ OK ] vault-path — /home/andrew/alfred/vault
    [ OK ] state-file — data/distiller_state.json
    [ OK ] candidate-threshold — 0.3
    [ OK ] backend — backend=claude
    [ OK ] anthropic-auth  (1798 ms) — count_tokens ok
    [ OK ] last-successful-extraction — last extraction 3.0h ago

[ OK ] instructor  (1012 ms)
    ...
    [ OK ] last-successful-poll — last poll: 2026-05-26T17:07:39.002820+00:00 (6s ago)
...
[FAIL] brief  (3949 ms)
    ...
    [FAIL] weather-api — unreachable: ReadTimeout: 
    [ OK ] last-successful-brief — last brief: 2026-05-25 (1d ago)
...
[ OK ] talker  (763 ms)
    ...
    [ OK ] anthropic-auth  (757 ms) — count_tokens ok
...
[ OK ] daily_sync  (0 ms)
    ...
    [ OK ] last-successful-fire — last fire: 2026-05-25 (1d ago)
...
Totals: ok=10 warn=0 fail=2 skip=0
...
{
  "mode": "quick",
  "started_at": "2026-05-26T17:07:44.096253+00:00",
  "finished_at": "2026-05-26T17:07:49.679500+00:00",
  "overall_status": "fail",
  "tools": [
    {
      "tool": "curator",
      ...
      "results": [
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "inbox empty; last process 0.5h ago",
          "latency_ms": null,
          "data": {
            "state_path": "data/curator_state.json",
            "last_run": "2026-05-26T16:39:22.058711+00:00",
            "elapsed_hours": 0.47,
    ...
    },
    {
      ...
      "results": [
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "last sweep 0.2h ago",
          "latency_ms": null,
          "data": {
            "state_path": "data/janitor_state.json",
            "last_sweep": "2026-05-26T16:58:02.663636+00:00",
            "elapsed_hours": 0.16
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 1921.148572997481
    },
    {
      "tool": "distiller",
      "status": "ok",
      "results": [
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "last extraction 3.0h ago",
          "latency_ms": null,
          "data": {
            "state_path": "data/distiller_state.json",
            "last_extraction": "2026-05-26T14:06:38.073847+00:00",
            "elapsed_hours": 3.02
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 1873.9946099958615
    },
    {
      "tool": "instructor",
      "status": "ok",
      "results": [
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "last poll: 2026-05-26T17:07:39.002820+00:00 (6s ago)",
          "latency_ms": null,
          "data": {
            "state_path": "data/instructor_state.json",
            "last_run_ts": "2026-05-26T17:07:39.002820+00:00",
            "age_seconds": 6
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 1011.6577959997812
    },
    {
      "tool": "surveyor",
      "status": "ok",
      "results": [
        ...
        },
        {
          ...
          "data": {
            ...
            "last_run": "2026-05-26T17:03:45.315648+00:00",
            "elapsed_hours": 0.07
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 844.5508209988475
    },
    {
      "tool": "brief",
      "status": "fail",
      "results": [
        ...
        },
        {
          "name": "weather-api",
          "status": "fail",
          "detail": "unreachable: ReadTimeout: ",
          "latency_ms": null,
          "data": {
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "last brief: 2026-05-25 (1d ago)",
          "latency_ms": null,
          "data": {
            "state_path": "data/brief_state.json",
            "most_recent_date": "2026-05-25",
            "today_local": "2026-05-26",
            "days_old": 1
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 3949.3974309953046
    },
    {
      "tool": "mail",
      "status": "ok",
      ...
      "detail": "",
      "elapsed_ms": 0.10200100223300979
    },
    {
      "tool": "talker",
      "status": "ok",
    ...
    },
    {
      ...
      "results": [
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "last fire: 2026-05-25 (1d ago)",
          "latency_ms": null,
          "data": {
      ...
      "detail": "",
      "elapsed_ms": 0.31910200050333515
    },
    {
      "tool": "cloudflared",
      "status": "ok",
    ...
    },
    {
      ...
      "detail": "",
      "elapsed_ms": 506.6115340014221
    }
  ],
  "elapsed_ms": 5583.257607999258
}
```
