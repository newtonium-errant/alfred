...
janitor_note: 'LINK001 — [[process/Alfred BIT]] parent process record does not exist
  ...
  the wikilink.'
mode: quick
name: Alfred BIT 2026-05-07
overall_status: ok
process: '[[process/Alfred BIT]]'
relationships:
- confidence: 1
  context: Both mention Alfred BIT run on different dates
  source: process/Alfred BIT 2026-05-07.md
  source_anchor: run Alfred BIT 2026-05-07
...
- confidence: 1
  ...
  source: run/Alfred BIT 2026-05-07.md
  source_anchor: BIT 2026-05-07
...
- confidence: 1
  ...
  type: related-to
started: '2026-05-07T05:55:01.316181-03:00'
status: completed
tags:
- bit
- health
...
Alfred BIT (quick) — [ OK ]
  started:  2026-05-07T08:55:00.005170+00:00
  finished: 2026-05-07T08:55:01.316148+00:00
  elapsed:  1311 ms
...
[ OK ] curator  (987 ms)
    ...
    [ OK ] anthropic-auth  (987 ms) — count_tokens ok

[ OK ] janitor  (961 ms)
    [ OK ] vault-path — /home/andrew/alfred/vault
    [ OK ] state-file — data/janitor_state.json
    [ OK ] backend — backend=claude
    [ OK ] anthropic-auth  (913 ms) — count_tokens ok
...
[ OK ] distiller  (891 ms)
    ...
    [ OK ] backend — backend=claude
    [ OK ] anthropic-auth  (872 ms) — count_tokens ok

[ OK ] instructor  (755 ms)
...
[ OK ] talker  (274 ms)
    ...
    [ OK ] anthropic-auth  (273 ms) — count_tokens ok
...
{
  "mode": "quick",
  "started_at": "2026-05-07T08:55:00.005170+00:00",
  "finished_at": "2026-05-07T08:55:01.316148+00:00",
  "overall_status": "ok",
  "tools": [
    {
      "tool": "curator",
    ...
    },
    {
      ...
      "detail": "",
      "elapsed_ms": 0.09487499482929707
    },
    {
      "tool": "talker",
      "status": "ok",
    ...
    },
    {
      ...
      "detail": "",
      "elapsed_ms": 143.50561803439632
    }
  ],
  "elapsed_ms": 1310.9929719939828
}
```
