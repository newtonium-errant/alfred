...
related_projects:
- project/Alfred.md
started: '2026-06-11T05:55:03.746864-03:00'
status: completed
tags:
- bit
- health
...
Alfred BIT (quick) — [ OK ]
  started:  2026-06-11T08:55:00.040780+00:00
  finished: 2026-06-11T08:55:03.746837+00:00
  elapsed:  3706 ms
...
[ OK ] curator  (2981 ms)
    ...
    [ OK ] anthropic-auth  (2597 ms) — count_tokens ok
...
[ OK ] instructor  (1513 ms)
    ...
    [ OK ] last-successful-poll — last poll: 2026-06-11T08:54:54.118146+00:00 (8s ago)
...
[ OK ] brief  (1517 ms)
    ...
    [ OK ] last-successful-brief — last brief: 2026-06-10 (1d ago)
...
[ OK ] talker  (1102 ms)
    ...
    [ OK ] anthropic-auth  (1095 ms) — count_tokens ok

[ OK ] transport  (1190 ms)
...
[ OK ] daily_sync  (0 ms)
    ...
    [ OK ] last-successful-fire — last fire: 2026-06-10 (1d ago)

[ OK ] cloudflared  (25 ms)
    [ OK ] last-successful-tunnel — tunnel connections active: 4

[ OK ] gcal  (677 ms)
    [ OK ] last-successful-gcal-sync — active probe ok; token last refreshed 15.2h ago (2026-06-10T17:41:08.620804Z)
...
{
  "mode": "quick",
  "started_at": "2026-06-11T08:55:00.040780+00:00",
  "finished_at": "2026-06-11T08:55:03.746837+00:00",
  "overall_status": "ok",
  "tools": [
    {
      "tool": "curator",
      ...
      "results": [
        ...
        },
        {
          ...
          "data": {
            ...
            "last_run": "2026-06-11T08:54:24.776194+00:00",
            "elapsed_hours": 0.01,
      ...
      "results": [
        ...
        },
        {
          ...
          "data": {
            ...
            "last_sweep": "2026-06-11T08:50:00.538307+00:00",
            "elapsed_hours": 0.08
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 2821.6631159884855
    },
    {
      "tool": "distiller",
      "status": "ok",
      "results": [
        ...
        },
        {
          ...
          "data": {
            ...
            "last_extraction": "2026-06-11T06:57:49.207543+00:00",
            "elapsed_hours": 1.95
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 2725.249242997961
    },
    {
      "tool": "instructor",
      "status": "ok",
      "results": [
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "last poll: 2026-06-11T08:54:54.118146+00:00 (8s ago)",
          "latency_ms": null,
          "data": {
            "state_path": "data/instructor_state.json",
            "last_run_ts": "2026-06-11T08:54:54.118146+00:00",
            "age_seconds": 8
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 1512.5802840047982
    },
    {
      "tool": "surveyor",
      "status": "ok",
      "results": [
        ...
        },
        {
          ...
          "data": {
            ...
            "last_run": "2026-06-11T08:50:06.080624+00:00",
            "elapsed_hours": 0.08
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 1186.8355900078313
    },
    {
      "tool": "brief",
      "status": "ok",
      "results": [
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "last brief: 2026-06-10 (1d ago)",
          "latency_ms": null,
          "data": {
            "state_path": "data/brief_state.json",
            "most_recent_date": "2026-06-10",
            "today_local": "2026-06-11",
            "days_old": 1
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 1517.4073230009526
    },
    {
      "tool": "mail",
      "status": "ok",
      ...
      "detail": "",
      "elapsed_ms": 0.12524599151220173
    },
    {
      "tool": "talker",
      "status": "ok",
    ...
    },
    {
      ...
      "results": [
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "last fire: 2026-06-10 (1d ago)",
          "latency_ms": null,
          "data": {
    ...
    },
    {
      ...
      "results": [
        {
          ...
          "status": "ok",
          "detail": "active probe ok; token last refreshed 15.2h ago (2026-06-10T17:41:08.620804Z)",
          "latency_ms": null,
          "data": {
            "token_path": "/home/andrew/alfred/data/secrets/gcal_token.json",
            "enabled": true,
            "last_refreshed": "2026-06-10T17:41:08.620804Z",
            "age_seconds": 54833,
            "active_probe": "ok"
          }
        }
      ...
      "detail": "",
      "elapsed_ms": 677.3056120000547
    }
  ],
  "elapsed_ms": 3706.066776998341
}
```
