...
Alfred BIT (quick) — [SKIP]
  started:  2026-04-20T08:54:53.032779+00:00
  finished: 2026-04-20T08:54:54.289198+00:00
  elapsed:  1256 ms
...
[ OK ] curator  (402 ms)
    ...
    [ OK ] anthropic-auth  (401 ms) — count_tokens ok

[ OK ] janitor  (426 ms)
    [ OK ] vault-path — /home/andrew/alfred/vault
    [ OK ] state-file — data/janitor_state.json
    [ OK ] backend — backend=claude
    [ OK ] anthropic-auth  (260 ms) — count_tokens ok
...
[SKIP] talker  (234 ms)
    ...
    [SKIP] tts-key — telegram.tts section absent — /brief feature is opt-in
    [ OK ] capture-handler-registered — capture_batch + capture_extract modules importable
    [ OK ] anthropic-auth  (233 ms) — count_tokens ok

Totals: ok=6 warn=0 fail=0 skip=1
...
{
  "mode": "quick",
  "started_at": "2026-04-20T08:54:53.032779+00:00",
  "finished_at": "2026-04-20T08:54:54.289198+00:00",
  "overall_status": "skip",
  "tools": [
    {
      "tool": "curator",
    ...
    },
    {
      ...
      "detail": "",
      "elapsed_ms": 0.11721602641046047
    },
    {
      "tool": "talker",
      "status": "skip",
      ...
      "detail": "",
      "elapsed_ms": 233.5666900034994
    }
  ],
  "elapsed_ms": 1256.4261859515682
}
```
