...
janitor_note: 'LINK001 — process/Alfred BIT target does not exist; parent process
  record for the Alfred BIT pipeline not present in vault. Human action: create the
  process record or retarget the wikilink. (DIR001 also reported by scanner — record
  has type=run but lives in process/; expected autofix.py to handle deterministically.)'
mode: quick
name: Alfred BIT 2026-05-17
overall_status: warn
process: '[[process/Alfred BIT]]'
relationships:
- confidence: 1
  context: Same Alfred BIT run series
  source: process/Alfred BIT 2026-05-17.md
  source_anchor: '[run] Alfred BIT 2026-05-17'
...
- confidence: 1
  ...
  source: run/Alfred BIT 2026-05-17.md
  source_anchor: Alfred BIT 2026-05-17
  target: run/Alfred BIT 2026-05-18.md
  target_anchor: Alfred BIT 2026-05-18
  type: related-to
- confidence: 1
  context: Same Alfred BIT series, consecutive dates
  source: run/Alfred BIT 2026-05-17.md
  source_anchor: Alfred BIT 2026-05-17
  target: run/Alfred BIT 2026-05-19.md
  target_anchor: Alfred BIT 2026-05-19
  type: related-to
started: '2026-05-17T05:55:02.238681-03:00'
status: completed
tags:
- bit
- health
...
Alfred BIT (quick) — [WARN]
  started:  2026-05-17T08:55:00.049391+00:00
  finished: 2026-05-17T08:55:02.238653+00:00
  elapsed:  2189 ms
...
[ OK ] curator  (1743 ms)
    ...
    [ OK ] anthropic-auth  (1304 ms) — count_tokens ok
...
[ OK ] janitor  (1347 ms)
    ...
    [ OK ] backend — backend=claude
    [ OK ] anthropic-auth  (1184 ms) — count_tokens ok
    [ OK ] last-successful-sweep — last sweep 0.3h ago

[ OK ] distiller  (1294 ms)
    [ OK ] vault-path — /home/andrew/alfred/vault
    [ OK ] state-file — data/distiller_state.json
    [ OK ] candidate-threshold — 0.3
    [ OK ] backend — backend=claude
    [ OK ] anthropic-auth  (1215 ms) — count_tokens ok
    [ OK ] last-successful-extraction — last extraction 1.8h ago

[ OK ] instructor  (908 ms)
    ...
    [ OK ] last-successful-poll — last poll: 2026-05-17T08:54:55.859426+00:00 (5s ago)
...
[ OK ] brief  (607 ms)
    ...
    [ OK ] last-successful-brief — last brief: 2026-05-16 (1d ago)
...
[ OK ] talker  (265 ms)
    ...
    [ OK ] anthropic-auth  (259 ms) — count_tokens ok
...
[ OK ] daily_sync  (1 ms)
    ...
    [ OK ] last-successful-fire — last fire: 2026-05-16 (1d ago)

[ OK ] cloudflared  (30 ms)
    [ OK ] last-successful-tunnel — tunnel connections active: 4

[WARN] gcal  (27 ms)
    [WARN] last-successful-gcal-sync — last gcal sync 29.6h ago (token may be stale)

Totals: ok=11 warn=1 fail=0 skip=0
...
{
  "mode": "quick",
  "started_at": "2026-05-17T08:55:00.049391+00:00",
  "finished_at": "2026-05-17T08:55:02.238653+00:00",
  "overall_status": "warn",
  "tools": [
    {
      "tool": "curator",
      ...
      "results": [
        ...
        },
        {
          ...
          "data": {
            ...
            "last_run": "2026-05-17T08:21:59.838664+00:00",
            "elapsed_hours": 0.55,
    ...
    },
    {
      ...
      "results": [
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "last sweep 0.3h ago",
          "latency_ms": null,
          "data": {
            "state_path": "data/janitor_state.json",
            "last_sweep": "2026-05-17T08:38:02.104081+00:00",
            "elapsed_hours": 0.28
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 1347.4100199528039
    },
    {
      "tool": "distiller",
      "status": "ok",
      "results": [
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "last extraction 1.8h ago",
          "latency_ms": null,
          "data": {
            "state_path": "data/distiller_state.json",
            "last_extraction": "2026-05-17T07:04:49.301214+00:00",
            "elapsed_hours": 1.84
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 1293.5937299625948
    },
    {
      "tool": "instructor",
      "status": "ok",
      "results": [
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "last poll: 2026-05-17T08:54:55.859426+00:00 (5s ago)",
          "latency_ms": null,
          "data": {
            "state_path": "data/instructor_state.json",
            "last_run_ts": "2026-05-17T08:54:55.859426+00:00",
            "age_seconds": 5
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 907.5738100218587
    },
    {
      "tool": "surveyor",
      "status": "ok",
      "results": [
        ...
        },
        {
          ...
          "data": {
            ...
            "last_run": "2026-05-17T08:54:51.357220+00:00",
            "elapsed_hours": 0.0
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 361.405219999142
    },
    {
      "tool": "brief",
      "status": "ok",
      "results": [
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "last brief: 2026-05-16 (1d ago)",
          "latency_ms": null,
          "data": {
            "state_path": "data/brief_state.json",
            "most_recent_date": "2026-05-16",
            "today_local": "2026-05-17",
            "days_old": 1
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 606.8978299736045
    },
    {
      "tool": "mail",
      "status": "ok",
      ...
      "detail": "",
      "elapsed_ms": 0.10240997653454542
    },
    {
      "tool": "talker",
      "status": "ok",
    ...
    },
    {
      ...
      "results": [
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "last fire: 2026-05-16 (1d ago)",
          "latency_ms": null,
          "data": {
      ...
      "results": [
        {
          ...
          "status": "warn",
          "detail": "last gcal sync 29.6h ago (token may be stale)",
          "latency_ms": null,
          "data": {
            "token_path": "/home/andrew/alfred/data/secrets/gcal_token.json",
            "enabled": true,
            "last_refreshed": "2026-05-16T03:16:44.940670Z",
            "age_seconds": 106696
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 27.41475001676008
    }
  ],
  "elapsed_ms": 2189.2721399781294
}
```
