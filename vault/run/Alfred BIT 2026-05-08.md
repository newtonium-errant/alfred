...
- confidence: 1
  ...
  source: run/Alfred BIT 2026-05-08.md
  source_anchor: BIT 2026-05-08
...
Alfred BIT (quick) — [ OK ]
  started:  2026-05-08T08:55:00.028160+00:00
  finished: 2026-05-08T08:55:01.694226+00:00
  elapsed:  1666 ms
...
[ OK ] curator  (1339 ms)
    ...
    [ OK ] anthropic-auth  (1339 ms) — count_tokens ok

[ OK ] janitor  (1310 ms)
    [ OK ] vault-path — /home/andrew/alfred/vault
    [ OK ] state-file — data/janitor_state.json
    [ OK ] backend — backend=claude
    [ OK ] anthropic-auth  (1200 ms) — count_tokens ok

[ OK ] distiller  (1176 ms)
    [ OK ] vault-path — /home/andrew/alfred/vault
    [ OK ] state-file — data/distiller_state.json
    [ OK ] candidate-threshold — 0.3
    [ OK ] backend — backend=claude
    [ OK ] anthropic-auth  (1127 ms) — count_tokens ok

[ OK ] instructor  (1003 ms)
...
[ OK ] talker  (214 ms)
    ...
    [ OK ] anthropic-auth  (213 ms) — count_tokens ok
...
{
  "mode": "quick",
  "started_at": "2026-05-08T08:55:00.028160+00:00",
  "finished_at": "2026-05-08T08:55:01.694226+00:00",
  "overall_status": "ok",
  "tools": [
    {
      "tool": "curator",
    ...
    },
    {
      ...
      "detail": "",
      "elapsed_ms": 0.09847292676568031
    },
    {
      "tool": "talker",
      "status": "ok",
    ...
    },
    {
      ...
      "detail": "",
      "elapsed_ms": 142.45911198668182
    }
  ],
  "elapsed_ms": 1666.0803209524602
}
```
