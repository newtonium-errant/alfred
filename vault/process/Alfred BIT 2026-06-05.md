...
janitor_note: 'LINK001 — broken wikilink [[process/Alfred BIT]] in process: field;
  ...
  records and run/Morning Brief. Out of janitor scope to create; operator action required
  to either create process/Alfred BIT.md or remove the link.'
mode: quick
name: Alfred BIT 2026-06-05
overall_status: ok
process: '[[process/Alfred BIT]]'
started: '2026-06-05T05:55:02.269267-03:00'
status: completed
tags:
- bit
- health
...
Alfred BIT (quick) — [ OK ]
  started:  2026-06-05T08:55:00.062411+00:00
  finished: 2026-06-05T08:55:02.269170+00:00
  elapsed:  4805 ms
...
[ OK ] curator  (4050 ms)
    ...
    [ OK ] anthropic-auth  (4025 ms) — count_tokens ok
...
[ OK ] janitor  (4119 ms)
    ...
    [ OK ] backend — backend=claude
    [ OK ] anthropic-auth  (3247 ms) — count_tokens ok
    [ OK ] last-successful-sweep — last sweep 0.6h ago

[ OK ] distiller  (3543 ms)
    [ OK ] vault-path — /home/andrew/alfred/vault
    [ OK ] state-file — data/distiller_state.json
    [ OK ] candidate-threshold — 0.3
    [ OK ] backend — backend=claude
    [ OK ] anthropic-auth  (3024 ms) — count_tokens ok
    [ OK ] last-successful-extraction — last extraction 2.0h ago

[ OK ] instructor  (1753 ms)
    ...
    [ OK ] last-successful-poll — last poll: 2026-06-05T08:54:31.539225+00:00 (31s ago)
...
[ OK ] brief  (1698 ms)
    ...
    [ OK ] last-successful-brief — last brief: 2026-06-04 (1d ago)
...
[ OK ] talker  (1243 ms)
    ...
    [ OK ] anthropic-auth  (1237 ms) — count_tokens ok

[ OK ] transport  (1422 ms)
...
[ OK ] daily_sync  (1 ms)
    ...
    [ OK ] last-successful-fire — last fire: 2026-06-04 (1d ago)

[ OK ] cloudflared  (45 ms)
    [ OK ] last-successful-tunnel — tunnel connections active: 4

[ OK ] gcal  (786 ms)
    [ OK ] last-successful-gcal-sync — active probe ok; token last refreshed 31.2h ago (2026-06-04T01:43:22.127871Z)
...
{
  "mode": "quick",
  "started_at": "2026-06-05T08:55:00.062411+00:00",
  "finished_at": "2026-06-05T08:55:02.269170+00:00",
  "overall_status": "ok",
  "tools": [
    {
      "tool": "curator",
      ...
      "results": [
        ...
        },
        {
          ...
          "data": {
            ...
            "last_run": "2026-06-05T08:14:28.726252+00:00",
            "elapsed_hours": 0.68,
      ...
      "results": [
        ...
        },
        {
          ...
          "data": {
            ...
            "last_sweep": "2026-06-05T08:21:45.802802+00:00",
            "elapsed_hours": 0.55
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 4119.185031042434
    },
    {
      "tool": "distiller",
      "status": "ok",
      "results": [
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "last extraction 2.0h ago",
          "latency_ms": null,
          "data": {
            "state_path": "data/distiller_state.json",
            "last_extraction": "2026-06-05T06:55:28.822021+00:00",
            "elapsed_hours": 1.99
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 3543.220017105341
    },
    {
      "tool": "instructor",
      "status": "ok",
      "results": [
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "last poll: 2026-06-05T08:54:31.539225+00:00 (31s ago)",
          "latency_ms": null,
          "data": {
            "state_path": "data/instructor_state.json",
            "last_run_ts": "2026-06-05T08:54:31.539225+00:00",
            "age_seconds": 31
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 1752.503999043256
    },
    {
      "tool": "surveyor",
      "status": "ok",
      "results": [
        ...
        },
        {
          ...
          "data": {
            ...
            "last_run": "2026-06-05T08:51:43.169172+00:00",
            "elapsed_hours": 0.06
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 1350.0804450595751
    },
    {
      "tool": "brief",
      "status": "ok",
      "results": [
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "last brief: 2026-06-04 (1d ago)",
          "latency_ms": null,
          "data": {
            "state_path": "data/brief_state.json",
            "most_recent_date": "2026-06-04",
            "today_local": "2026-06-05",
            "days_old": 1
          }
        }
      ],
      "detail": "",
      "elapsed_ms": 1697.7019970072433
    },
    {
      "tool": "mail",
      "status": "ok",
    ...
    },
    {
      ...
      "results": [
        ...
        },
        {
          ...
          "status": "ok",
          "detail": "last fire: 2026-06-04 (1d ago)",
          "latency_ms": null,
          "data": {
    ...
    },
    {
      ...
      "results": [
        {
          ...
          "status": "ok",
          "detail": "active probe ok; token last refreshed 31.2h ago (2026-06-04T01:43:22.127871Z)",
          "latency_ms": null,
          "data": {
      ...
      "detail": "",
      "elapsed_ms": 786.418323055841
    }
  ],
  "elapsed_ms": 4804.70808793325
}
```
