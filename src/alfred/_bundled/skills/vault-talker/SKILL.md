...
- **Download failed** (network or transport, any kind) — the bot used to reply *"sorry, couldn't fetch your <kind> file — try sending it again?"* (`bot.py:4128-4130`). Wait for the retry.
