...
async def test_every_register_helper_has_wire_transport_app_kwarg():
    ...
    expected_mapping = {
        ...
        # Ticket intake (VERA→KAL-LE→GitHub pipeline, 2026-06-11): the
...
async def test_wire_transport_app_logs_skip_for_omitted_kwargs(
    ...
    expected_skips = {
        ...
        # Ticket intake (VERA→KAL-LE→GitHub pipeline, 2026-06-11) —
        ...
        # ``transport.jeeves.disabled`` info log; this debug event is the
        # wire-level skip signal.
